...
- (void)setItemsCount:(NSUInteger)itemsCount
{
    ...
    bigLine.width = SCREEN_WIDTH - LR_SPACE * 2 - ITEM_ICON_WIDTH * 2;
    bigLine.height = 4.5;
...
- (void)createItem:(NSUInteger)itemIndex
{
    ...
    if (itemIndex == 0) { // 首节点
        ...
        itemIcon.right = SCREEN_WIDTH - 32;
    ...
    itemIcon.backgroundColor = RGB(247, 247, 247);
    ...
    itemLabel.textColor = RGB(31, 31, 31);
