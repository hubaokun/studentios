...
- (void)setupBarButtonItem
{
    ...
    [backButton setImageEdgeInsets:UIEdgeInsetsMake(0, -25, 0, 25)];
    [backButton setImage:[UIImage imageNamed:@"arrow_back_userinfohome"] forState:UIControlStateNormal];
    [backButton addTarget:self action:@selector(back) forControlEvents:UIControlEventTouchUpInside];
    UIBarButtonItem *backItem = [[UIBarButtonItem alloc] initWithCustomView:backButton];
    [self.navigationItem setLeftBarButtonItem:backItem];
    
    UIButton *clearButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 44, 44)];
    [clearButton setImageEdgeInsets:UIEdgeInsetsMake(0, 20, 0, -20)];
    [clearButton setImage:[UIImage imageNamed:@"回收站"] forState:UIControlStateNormal];
        ...
        if ([obj isKindOfClass:[NSString class]]) {
            ...
            if (cell == nil) {
                ...
                if (model.isSender) {
                    ...
                    NSString* avatarStr = [user_info objectForKey:@"avatarStr"];
                    [cell.headImageView sd_setImageWithURL:[NSURL URLWithString:avatarStr] placeholderImage:[UIImage imageNamed:@"people_default"]];
                }
                else{
                    cell.headImageView.image = [UIImage imageNamed:@"客服"];
                }
            }
